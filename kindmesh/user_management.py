...
def render_user_management(db: Any, username: str) -> None:
    """
    Render user management components for administrators.
    
    This function provides a user interface for administrators to manage users,
    including viewing all users, promoting users to admin, demoting admins to
    friends (with voting system), deleting users, and creating new users with
    specific roles.
    
    Args:
        db: Database connection object used for retrieving and modifying user data
        username: Username of the administrator performing the user management
    """
